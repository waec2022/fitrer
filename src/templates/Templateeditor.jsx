...
import { PropellerAdsSlot, AffiliateSlot } from "../components/AdSlot.jsx";
    ...
    <div style={{ maxWidth: "620px", margin: "0 auto", padding: "24px 20px 60px" }}>
      ...
      {image && (
        <>
          ...
          <PropellerAdsSlot c={c} placement="text-in-image" slotId="AD_TEXTIMG_AFTER_DOWNLOAD" />
          <AffiliateSlot c={c} placement="text-in-image" slotId="AFF_TEXTIMG_RECOMMENDED" />
